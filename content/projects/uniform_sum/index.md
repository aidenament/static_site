...
This paper shows that the expected number of i.i.d. variables uniformly distributed between 0 and 1 required to sum past 1 (ex: 0.23 + 0.71 + 0.56 is three variables) is e. 
